...
def estimate_tokens(text):
    from .ParseTextAndLogFiles import format_line_range
    from .GitAndVersionControlOperations import format_git_diff_summary
    from .AnalyzeAndRankEvidenceWithModels import format_model_analysis, format_preflight
