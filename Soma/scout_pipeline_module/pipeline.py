...
async def run_gather(user_prompt, project_root, recent_roots_json, token_budget=DEFAULT_TOKEN_BUDGET, use_local_summary=False, analysis_depth='deterministic'):
    ...
    from .ranker import rank_evidence_with_model, fallback_summary, analyze_packet_with_model, summarize_with_ollama, should_use_model_summary
    from .utils import dedupe_strings, parse_recent_roots, normalize_path
