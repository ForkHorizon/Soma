...
extension RusToPromptViewModel {
    static let translatorPresets: [RusToPromptModelPreset] = [
        ...
        RusToPromptModelPreset(model: "deepseek-v4-flash", quality: "High", speed: "Fast", ram: "Paid API", detail: "DeepSeek paid API translator. Lower-cost default DeepSeek option for Russian-English translation.", recommended: false, provider: "deepseek"),
        RusToPromptModelPreset(model: "deepseek-v4-pro", quality: "Best", speed: "Medium", ram: "Paid API", detail: "DeepSeek paid API translator. Use for harder translation cases when quality matters more than token cost.", recommended: false, provider: "deepseek"),
    ...
    static let analyzerPresets: [RusToPromptModelPreset] = [
        ...
        RusToPromptModelPreset(model: "deepseek-v4-flash", quality: "High", speed: "Fast", ram: "Paid API", detail: "DeepSeek paid API improver. Lower-cost default DeepSeek option for prompt polishing.", recommended: false, provider: "deepseek"),
        RusToPromptModelPreset(model: "deepseek-v4-pro", quality: "Best", speed: "Medium", ram: "Paid API", detail: "DeepSeek paid API improver. Use for harder prompt-polish cases when quality matters more than token cost.", recommended: false, provider: "deepseek"),
