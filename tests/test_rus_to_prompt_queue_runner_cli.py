...
def _queue_dry_run_args(cases: Path, control: Path, out_dir: Path) -> list[str]:
    return [
        ...
        "--cases-file", str(cases),
        "--limit", "1",
        "--translator-models", "qwen3.5:9b",
        "--analyzer-models", "qwen3.5:9b",
        "--confidence-referee", "hybrid",
        "--confidence-model", "gemini-3.1-flash-lite-preview",
        "--confidence-reasoning-effort", "medium",
        "--confidence-workers", "1",
        "--confidence-batch-size", "1",
        "--translation-confidence-threshold", "0.75",
        "--codex-stage-reasoning-effort", "medium",
        "--workers", "1",
        "--stage-cooldown-seconds", "0",
        "--control-file", str(control),
        "--resume-existing",
        "--local-confidence-models", "qwen3-coder:30b-a3b-q4_K_M", "qwen3:30b-a3b",
        "--hybrid-confidence-gemini-model", "gemini-3.1-flash-lite-preview",
        "--hybrid-confidence-fallback-referee", "gemini",
